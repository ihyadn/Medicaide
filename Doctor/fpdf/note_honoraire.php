...
$pdf->Image('note.PNG',0, 5, 140, 45);
$pdf->Ln(18);
$pdf->SetFont('', 'BI');
$pdf->Cell(60);
$pdf->Ln(26);
$pdf->Cell(0, 1, 'Fait A Casablanca Le :' . date('d/m/Y'), 0, 1, 'C');
$pdf->Ln(18);
$pdf->Cell(25);
$pdf->Ln(1);
$pdf->Ln(1);
...
$pdf->Ln(15);
$pdf->Write($h, $retrait .utf8_decode("a réglé des honoraires médicaux en contrepartie des actes inscrits sur la"));
$pdf->Ln(15);
$pdf->Write($h, $retrait .utf8_decode("feuille de soins médicales ci-jointe, et ce, pour un montant total de :   ........"));
$pdf->Ln(10);
$pdf->Write($h, utf8_decode("  ..............................................................."));

//$pdf->Write($h, $retrait .utf8_decode("de ................   jours à compter du  :   .................. sauf complication ") );
...
$pdf->Cell(8);
$pdf->Ln(15);
$pdf->Write($h, utf8_decode("Arrétée la présente note d'honoraires médicaux à la somme de  .............."));
$pdf->Ln(10);
$pdf->Write($h, utf8_decode("  ..............................................................."));
